...
I built a local-first Personal Finance CFO Agent as a portfolio project.

The idea is simple: take fictional transaction data and turn it into the kind of monthly packet a CFO or FP&A team would use to understand what happened, why it matters, and what to do next.

It generates:

- a monthly CFO report
- a trend summary
